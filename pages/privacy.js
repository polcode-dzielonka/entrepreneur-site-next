			...
			<main className="content">
				<article className="article">
					...
					<div className="main-content">
						<p>
							The below is a Privacy Policy we have put together for our users.
							Please read all the information below carefully and contact us if
							you have any questions.
						</p>
						<p>
							At <strong>Derivative Media Ltd</strong> ("us", "we", or "our")
							the privacy of our visitors is extremely important. This Privacy
							Policy outlines the types of personal information that is received
							and collected and how it is used. This Privacy Policy is reviewed
							and revised from time to time. You will want to revisit it
							regularly. Your use of this site, in any and all forms,
							constitutes an acceptance of this Privacy Policy.
						</p>
						<ol>
						...
						<ol>
							...
							<p>
								<ul>* Internet Protocol addresses (IP)</ul>
								<ul>* Types of browser</ul>
								<ul>* Browser version</ul>
								<ul>* Internet Service Provider (ISP)</ul>
								<ul>* Date and time stamp</ul>
								<ul>* Referring and exit pages</ul>
								<ul>
						...
						<ol>
							...
							<p>
								...
								and to record user-specific information on visits and pages the
								user views so as to provide a custom experience. In regard to
							...
							<ul>
								...
								<li>
									...
									media network will have record of this and may display your
									name or identifier in relation to this action.
								</li>
								<li>
						...
						<ol>
							...
							<p>
								...
								party sites to you after you visited our Site. We and our third
								party vendors, like Google, use first party cookies (such as the
								Google Analytics cookie) and third party cookies (such as the
								DoubleClick cookie) to inform, optimize and serve ads based on
								your past visits to our Site.
							</p>
							<p>
								...
								Ads Settings page. Google also recommends installing the Google
								Analytics Opt-out Browser Add-on for your browser. Google
								Analytics Opt-out Browser Add-on provides visitors with the
						...
						<ol>
							...
							<p>
								...
								solely for the convenience and information of our visitors. You
								access such linked Websites at your own risk. These websites are
								not subject to this Privacy Policy. You should check the privacy
								policies, if any, of those individual websites to see how the
								operators of those third-party websites will utilize your
								personal information. In addition, these websites may contain a
								link to Websites of our affiliates. The websites of our
								affiliates are not subject to this Privacy Policy, and you
								should check their individual privacy policies to see how the
								operators of such websites will utilize your personal
								information.
							</p>
							<p>
								...
								Not Track by visiting the Preferences or Settings page of your
								web browser.
							</p>
						</ol>
						...
						<ol>
							...
							<p>
								...
								allows an analysis of the success of online marketing campaigns.
								Because of these tracking pixels, we may see if and when you
								open an email and which links within the email you click. Also,
								this allows the Website to adapt the content of future
								newsletters to the interests of the user. This behavior will not
