			...
			<main className="content">
				<article className="article">
					...
					<div className="main-content">
						<h2>Overview</h2>
						<p>
							This website is operated by <strong>Derivative Media Ltd</strong>.
							Throughout the site, the terms “we”, “us” and “our” refer to{" "}
							<strong>Derivative Media Ltd</strong>.
						</p>
						<p>
							<strong>Derivative Media Ltd</strong> offers this website,
						...
						<p>
							In no case shall <strong>Derivative Media Ltd</strong>, our
						...
						<p>
							...
							accordance with the laws of 20-22 Wenlock Road, London, LND, N1
							7GU, United Kingdom.
						</p>
